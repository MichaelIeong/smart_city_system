...
public class DeviceController {
    ...
    public ResponseEntity<String> getDeviceURL(@PathVariable String deviceId) {
    ...
    public ResponseEntity<Boolean> getDeviceIsSensor(@PathVariable String deviceId) {
    ...
    public ResponseEntity<String> getDeviceCapabilities(@PathVariable String deviceId) {
    ...
    public ResponseEntity<String> getDeviceType(@PathVariable String deviceId) {
    ...
    public ResponseEntity<DeviceInfo> getDeviceById(@PathVariable String deviceId) {
