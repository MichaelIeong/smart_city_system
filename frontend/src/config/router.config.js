...
export const asyncRouterMap = [
  {
    ...
    children: [
      // resource management资源管理
      {
        ...
        redirect: '/resource/physical-resource',
        component: RouteView,
        meta: { title: 'menu.resource', keepAlive: true, icon: bxAnaalyse, permission: ['dashboard'] },
        children: [
          {
            // 物理资源
          ...
          // 信息资源
          {
            ...
            name: 'CyberResource',
            meta: { title: 'menu.resource.cyber-resource', target: '_blank' }
          },
          // 社会资源
          {
      ...
      // eventfusion事件融合
      {
        ...
        name: 'eventfusion',
        component: RouteView,
        redirect: '/eventfusion/eventfusion-list',
        meta: { title: 'menu.eventfusion', icon: 'table', permission: ['table'] },
        children: [
          {
            // 规则列表
            path: '/eventfusion/eventfusion-list/:pageNo([1-9]\\d*)?',
            name: 'TableListWrapper',
            hideChildrenInMenu: true, // 强制显示 MenuItem 而不是 SubMenu
            component: () => import('@/views/list/EventFusionList'),
            meta: { title: 'menu.eventfusion.list', keepAlive: true, permission: ['table'] }
          }
        ]
      },
      ...
      // servicegroup服务组合
      {
        ...
        name: 'servicegroup',
        component: RouteView,
        redirect: '/servicegroup/servicegroup-list',
        meta: { title: 'menu.servicegroup', icon: 'profile', permission: ['profile'] },
        children: [
          {
            path: '/servicegroup/servicegroup-list',
            name: 'ProfileBasic',
      ...
      // Exception
      {
        ...
        meta: { title: 'menu.project-management', icon: 'warning', permission: ['exception'] },
        children: [
          {
            path: '/exception/403',
            name: 'Exception403',
