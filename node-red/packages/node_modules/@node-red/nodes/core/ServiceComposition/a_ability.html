<script type="text/html" data-template-name="ability">
    ...
    <div class="form-row">
        <label for="node-input-ability"><i class="fa fa-cogs"></i> Ability</label>
        <select id="node-input-ability">
...
<script type="text/javascript">
    RED.nodes.registerType('ability', {
        ...
        oneditprepare: function () {
            ...
            // 初始化Device Name下拉框
            $.getJSON("/ability/devicelist?type=device", function (data) {
            ...
            // 初始化Device Type下拉框
            $.getJSON("/ability/devicelist?type=deviceType", function (data) {
            ...
            // 初始化Ability下拉框
            $.getJSON("/ability/abilitylist", function (data) {
                var abilitySelect = $("#node-input-ability");
                data.abilitys.forEach(function (ability) {
                    abilitySelect.append($("<option></option>").attr("value", ability.id).text(ability.name));
                });
                abilitySelect.val(node.ability);
            });
        ...
        oneditsave: function () {
            ...
            this.ability = $("#node-input-ability").val();
        }
    });
</script>