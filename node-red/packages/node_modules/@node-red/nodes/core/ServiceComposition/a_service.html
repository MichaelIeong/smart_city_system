<script type="text/html" data-template-name="service">
...
<script type="text/javascript">
    RED.nodes.registerType('service', {
        ...
        oneditprepare: function () {
            ...
            // 初始化Device Name下拉框
            $.getJSON("/service/devicelist?type=device", function (data) {
            ...
            // 初始化Device Type下拉框
            $.getJSON("/service/devicelist?type=deviceType", function (data) {
            ...
            // 初始化Service下拉框
            $.getJSON("/service/servicelist", function (data) {
                var serviceSelect = $("#node-input-service");
                data.services.forEach(function (service) {
                    serviceSelect.append($("<option></option>").attr("value", service.id).text(service.name));
                });
                serviceSelect.val(node.service);
            });
