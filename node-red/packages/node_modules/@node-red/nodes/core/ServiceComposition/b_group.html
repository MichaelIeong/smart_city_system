<script type="text/html" data-template-name="composition">
    ...
    <div class="form-row">
        <label for="node-input-group-name"><i class="fa fa-object-group"></i> Composition Name</label>
        <input type="text" id="node-input-group-name" placeholder="Enter Composition Name" />
    </div>
</script>
...
<script type="text/javascript">
    RED.nodes.registerType('composition', {
        ...
        label: function () {
            if (this.groupName) {
                return "Composition : " + this.groupName;
            } else {
                return "Composition";
            }
        },
        ...
        oneditsave: function () {
            var node = this;
            node.groupName = $("#node-input-group-name").val();
            node.services = [];
