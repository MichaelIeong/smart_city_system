...
<script type="text/javascript">
    RED.nodes.registerType('sensor', {
        ...
        oneditprepare: function () {
            ...
            var projectName = "your_project_name"; // Replace this with actual projectname variable
            $.getJSON("http://127.0.0.1:8080/api/fusion/sensor?projectname=" + projectName, function (data) {
